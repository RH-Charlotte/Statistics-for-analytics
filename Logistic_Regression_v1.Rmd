...
confusionMatrix(churndata$Dropout, churndata$PredBin, 0.5)
sensitivity(churndata$Dropout, churndata$PredBin, 0.5)
specificity(churndata$Dropout, churndata$PredBin, 0.5)
precision(churndata$Dropout, churndata$PredBin, 0.5)
npv(churndata$Dropout, churndata$PredBin, 0.5)
